...
- **Retention Calculation**: Visualize cumulative storage over several months
...
- JavaScript (Vanilla)
- [jsPDF](https://github.com/parallax/jsPDF) for report generation
...
- **Paramètres Avancés** : Ajustez le taux de modification journalier (%) et appliquez des préfixes de compression selon le type de données (Vidéos, BDD, Système, etc.)
...
- JavaScript (Vanilla)
- [jsPDF](https://github.com/parallax/jsPDF) pour la génération de rapports
- Google Fonts (Space Mono & DM Sans)

### Installation & Utilisation
1. Faite un clone du repository
